...
```
javascript:(function(){Game.LoadMod('https://cdn.jsdelivr.net/gh/price-gaines/cookie-minmax@v0.11.1/src/minmax.js')})();
```

**Console** — paste into the browser devtools console (F12):

```js
Game.LoadMod('https://cdn.jsdelivr.net/gh/price-gaines/cookie-minmax@v0.11.1/src/minmax.js');
```

**Mod Manager** — add the same `@v0.11.1` URL as a custom mod.
...
> Pin a **version tag** (`@v0.11.1`), not `@main`. Tags are immutable, so jsDelivr caches them
